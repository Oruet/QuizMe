	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form  action="http://localhost/QuizMe/AddEvent.php" method="post">
					...
					<div class="modal-body">					
						<div class="form-group">
							...
							<input type="text" name="InputDenumire" class="form-control" required>							
						</div>						
						<div class="form-group">
							<label>Start(hh:mm mm dd yyyy)</label>
							<input type="datetime-local" name="InputStart" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Stop(hh:mm mm dd yyyy)</label>
							<input name="InputStop" type="datetime-local" class="form-control" required>
						</div>	
						<div class="form-group">
							<label>Descriere</label>
							<textarea name="InputDescriere" class="form-control" required></textarea>
						</div>
